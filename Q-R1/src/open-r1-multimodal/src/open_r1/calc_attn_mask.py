...
def parse_args():
    ...
    parser.add_argument("--output_dir",default="./Q-R1/src/open-r1-multimodal/src/open_r1/attn_vis/qwen25vl-videorefer-refined-detailed-125k-detail-125k-insit-21k-miou-multilayer-test-single-turn-3", type=str, help="Directory to save the attention weights.")
    # parser.add_argument("--output_dir",default="./Q-R1/src/open-r1-multimodal/src/open_r1/attn_vis/<MODEL_PATH>", type=str, help="Directory to save the attention weights.")
    # parser.add_argument("--model_path",default="<MODEL_PATH>", type=str, help="Directory to save the attention weights.")
    parser.add_argument("--model_path", type=str, default="./Q-R1/src/open-r1-multimodal/output/qwen25vl-videorefer-refined-detailed-125k-detail-125k-insit-21k-miou-multilayer-test-single-turn-3")
...
def main():
    ...
    josn_path = './data/DAMO-NLP-SG/VideoRefer-700K/refined-format-videorefer-detailed-caption-125k-part.json'
    # josn_path = './data/DAMO-NLP-SG/VideoRefer-Bench/refined-VideoRefer-Bench-D.json'
    save_root = './Q-R1/src/open-r1-multimodal/src/open_r1/videorefer_d_vis_new_sup'
    with open(josn_path, 'r') as f:
        vision_info = json.load(f)

    # vision_info = vision_info[50:100]
    ...
    # save_path = os.path.join(args.output_dir, "all_stat_results_20_50.json")
